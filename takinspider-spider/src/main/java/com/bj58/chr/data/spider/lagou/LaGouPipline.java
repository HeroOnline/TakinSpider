 ...
 * @see
 */
public class LaGouPipline implements PageModelPipeline<LaGouJobInfo> {

    private static final Logger logger = LoggerFactory.getLogger(LaGouPipline.class);

    private static final File wuyjob = new File("D:/opendata/lagou/job.txt");
    ...
    @Override
    public void process(LaGouJobInfo job, Task task) {
        try {
