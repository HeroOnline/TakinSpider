 ...
 * @see
 */
public class WuBaPipline implements PageModelPipeline<WuBaJobInfo> {

    private static final Logger logger = LoggerFactory.getLogger(WuBaPipline.class);

    private static final File wuyjob = new File("D:/opendata/58/job.txt");
    ...
    @Override
    public void process(WuBaJobInfo job, Task task) {
        try {
