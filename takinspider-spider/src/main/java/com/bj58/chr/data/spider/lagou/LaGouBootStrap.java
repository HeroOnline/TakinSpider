...
public class LaGouBootStrap {
    ...
    public static void main(String[] args) {
        try {
            ...
            String starturl = "http://www.lagou.com/?utm_source=m_cf_cpt_baidu_pc";
            //            String starturl = "http://jobs.51job.com/guangzhou/79841625.html?s=0";
            OOSpider.create(site, new LaGouPipline(), LaGouJobInfo.class).setScheduler(sche).addUrl(starturl).thread(2).run();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
